...
describe('L2NoBridgingSmartVault', () => {
  let smartVault: Contract, holder: Contract, funder: Contract, holdingToken: Contract, mimic: Mimic
  ...
  beforeEach('deploy smart vault', async () => {
    const deployer = await deploy('L2NoBridgingSmartVaultDeployer', [], owner, { Deployer: mimic.deployer.address })
