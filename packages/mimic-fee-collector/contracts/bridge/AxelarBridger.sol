...
contract AxelarBridger is BaseAction, TokenThresholdAction {
    using FixedPoint for uint256;
    using EnumerableSet for EnumerableSet.UintSet;
    using EnumerableSet for EnumerableSet.AddressSet;

    // Axelar source number
    uint8 internal constant AXELAR_SOURCE = 1;
    ...
    function call(uint256 chainId, address token, uint256 amount) external auth nonReentrant {
