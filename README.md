...
<p align="center">
  <a href="https://github.com/mimic-fi/v2-smart-vaults/actions/workflows/ci.yml">
...
This monorepo keeps track of all the official Smart Vault implementations
...
$ git clone https://github.com/mimic-fi/v2-smart-vaults
